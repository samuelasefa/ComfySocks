...
namespace ComfySocks.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            ApplicationUser users = UserManager.FindByName(model.Email);
            if (users != null)
            {
                if (users.IsActive)
                {
        ...
        {
            var users = (from u in db.Users where u.FullName != "ComfySocks" select u).ToList();
            ViewBag.users = users;
            return View(users);
        }
        ...
        public ActionResult Activate(string id)
        {
            ...
            db.SaveChanges();
            var user = (from u in db.Users where u.FullName != "ComfySocks" select u).ToList();
            ViewBag.users = user;
            ViewBag.successMessage = "User Activited";
        ...
        public ActionResult Block(string id)
        {
            ...
            var user = (from u in db.Users where u.FullName != "ComfySocks" select u).ToList();
            ViewBag.users = user;
            ViewBag.successMessage = "User Blocked";
            return View("UserList");
        }
        //
        ...
        {
            ViewBag.Role = new SelectList(db.Roles.Where(u=> !u.Name.Contains("Super Admin")).ToList(), "Name", "Name");
            return View();
        }
