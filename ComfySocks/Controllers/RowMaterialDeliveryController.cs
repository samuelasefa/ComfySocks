...
{
    public class RowMaterialDeliveryController : Controller
    {
        private ApplicationDbContext db = new ApplicationDbContext();
        // GET: RowMaterialDelivery
        [Authorize(Roles = "Super Admin, Admin")]

        public ActionResult RowMaterialDeliveryList(int id)
        {
        ...
        [HttpPost]
        public ActionResult NewRowMaterialDelivery(Delivery delivery)
        {
        ...
        public ActionResult RowMaterialDeliveryDetail(int? id)
        {
            if (id == 0) {
        ...
        public ActionResult NewRowMaterilDeliveryInfo()
        {
            if (TempData[User.Identity.GetUserId() + "selectedDelivery"] == null)
            {
        ...
        public ActionResult NewRowMaterilDeliveryInfo(DeliveryInformation deliveryInformation)
        {
            if (TempData[User.Identity.GetUserId() + "selectedDelivery"] == null)
            {
                TempData[User.Identity.GetUserId() + "errorMessage"] = "Unable to load selected Delivery";
        ...
        //approval delivery rowmaterial
        public ActionResult DeliveryApproved(int? id)
        {
            if (id == null)
            {
        ...
        //rejecting delivery rowmaterial

        public ActionResult DeliveryRejected(int? id)
        {
            if (id == null)
            {
                TempData[User.Identity.GetUserId() + "errorMessage"] = "Invalid Navigation detected!. Try again";
